    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-fp-border bg-fp-surface accent-fp-neon-blue" />
              <span className="text-sm text-fp-gray">Remember me</span>
            </label>
            <a href="/forgot-password" className="text-sm text-fp-neon-blue hover:text-fp-neon-blue/80 transition-colors">
              Forgot password?
            </a>
          </div>
        ...
        <p className="text-center text-sm text-fp-gray mt-6">
          ...
          <a href="/register" className="text-fp-neon-blue hover:text-fp-neon-blue/80 font-medium transition-colors">
            Create Account
          </a>
        </p>
      </motion.div>
